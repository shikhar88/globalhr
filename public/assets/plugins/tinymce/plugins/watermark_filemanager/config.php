...
$upload_dir = '/assets/editor_images'; // path from base_url to upload base dir
$current_path = '../../../../editor_images/'; // relative path from filemanager folder to upload files folder
