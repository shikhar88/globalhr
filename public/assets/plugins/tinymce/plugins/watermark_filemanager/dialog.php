...
if(isset($_GET['watermark'])){
	...
	$watermark_thumb = $thumbs_path.$subdir. $watermark_file;
	$watermark_src=$base_url.$upload_dir.'/'.$watermark_file;
}
?>
...
<!----- header div start ------->
			<div class="filters">
				...
				<div class="span4">
				    ...
				    <?php } ?>
				    <?php if(isset($watermark_thumb)){?>
				    	<ul class="grid cs-style-2" id="watermark_display">
				    	<li class="ff-item-type-2">
				    	<figure>
							<div class="img-precontainer">
							<div class="img-container"><span></span>
							<img data-src="holder.js/122x91" alt="image"  src="<?php echo $watermark_thumb; ?>">
							</div>
							</div>
							<div class="box">				
							...
							<figcaption>
							    <a class="preview" title="Preview
							    " data-url="<?php echo $watermark_src;?>" data-toggle="lightbox" href="#previewLightbox"><i class=" icon-eye-open"></i></a>
							    <a href="javascript:void('');" class="erase-button"
							    onclick=" if(confirm('Are you sure you want to remove the current watermark image?')){ removeWatermark(); $(this).parent().parent().parent().parent().hide(200); return false;}" title="Remove watermark"><i class="icon-trash"></i></a>    
							</figcaption>
						</figure>
						</li>
						</ul>
